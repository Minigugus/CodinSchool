...
USER.get('/', api.check, (req, res) => 
	db.queryAll('SELECT ski_id, ski_name, (ski_level / ski_level_max::float) AS ski_ratio FROM skill S INNER JOIN skill_account SA ON SA.ski_id=S.ski_id WHERE SA.acc_id = $1;', [ req.session.account_id ])
