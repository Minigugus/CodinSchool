    ...
    <div class="ui container">
      ...
      <div class="text-center" style="position:fixed;left: 30px;z-index:999;">
        ...
        <br>
          ...
          <a @click.prevent="setUserData({firstname: 'Antoine', lastname: 'Sauvage', email: 'rigwild@example.com', avatar: 'https://via.placeholder.com/150x150', roles: ['Utilisateur', 'Administrateur']})" class="link item">
