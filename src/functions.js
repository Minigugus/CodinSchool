...
const mimes = [
  ...
  { text: 'text/html', value: 'codemirror/mode/htmlmixed/htmlmixed.js' },
  ...
  { text: 'text/x-c++src', value: 'codemirror/mode/clike/clike.js' },
  { text: 'text/x-cassandra', value: 'codemirror/mode/sql/sql.js' },
  { text: 'text/x-ceylon', value: 'codemirror/mode/clike/clike.js' },
  ...
  { text: 'text/x-csharp', value: 'codemirror/mode/clike/clike.js' },
  { text: 'text/x-csrc', value: 'codemirror/mode/clike/clike.js' },
  ...
  { text: 'text/x-java', value: 'codemirror/mode/clike/clike.js' },
  { text: 'text/x-julia', value: 'codemirror/mode/julia/julia.js' },
  { text: 'text/x-kotlin', value: 'codemirror/mode/clike/clike.js' },
  ...
  { text: 'text/x-modelica', value: 'codemirror/mode/modelica/modelica.js' },
  ...
  { text: 'text/x-nesc', value: 'codemirror/mode/clike/clike.js' },
  { text: 'text/x-nginx-conf', value: 'codemirror/mode/nginx/nginx.js' },
  { text: 'text/x-nsis', value: 'codemirror/mode/nsis/nsis.js' },
  { text: 'text/x-objectivec', value: 'codemirror/mode/clike/clike.js' },
  ...
  { text: 'text/x-scala', value: 'codemirror/mode/clike/clike.js' },
  ...
  { text: 'text/x-squirrel', value: 'codemirror/mode/clike/clike.js' },
  ...
  { text: 'text/x-ttcn', value: 'codemirror/mode/ttcn/ttcn.js' },
  ...
  { text: 'x-shader/x-vertex', value: 'codemirror/mode/clike/clike.js' }
]
