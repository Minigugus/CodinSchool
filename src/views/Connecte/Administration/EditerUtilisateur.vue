  ...
  <div class="ui text vertical segment container">
    ...
    >
      <template v-slot="{ result: { error, data }, isLoading }">
        ...
        <!-- Erreur -->
        <div v-else-if="error || userSupprime">
          <!-- Erreur de chargement ou notification d'utilisateur supprimé -->
          <GoBack to="/Administration/gererUtilisateurs" text="Retour à la liste des utilisateurs" />
          <Alerte :liste-msg="[userSupprime || error.message]" :type-alerte="userSupprime ? 'Succès' : 'Erreur'" :fermable="false" />
        </div>
